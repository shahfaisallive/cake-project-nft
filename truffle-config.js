...
const mnm = "warrior arctic peanut athlete sausage flee broccoli tip topic front inside famous welcome idea noodle"
//
// const fs = require('fs');
...
module.exports = {
  ...
  compilers: {
    solc: {
      version: ">=0.4.22 <0.8.4",      // Fetch exact version from solc-bin (default: truffle's version)
